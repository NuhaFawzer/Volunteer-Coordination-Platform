...
<div class="modal" id="loginModal">
    ...
    <p style="margin: 10px 0; text-align: center;">
        <a href="forgot_password.php"style="color: #47ace7ff; text-decoration: block";>Forgot Password?</a>
    </p>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Show modal automatically if there’s a login error
    <?php if (!empty($login_error)) : ?>
        if (loginModal) {
